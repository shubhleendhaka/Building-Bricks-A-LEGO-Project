...
def adjust_points(df, theme, threshold, max_attempts):
    ...
    while attempts < max_attempts:
        ...
        for i, j in pairs_to_adjust:
            ...
            # TODO: CHANGE HOW MUCH TO ADJUST POINTS
            # How much to adjust x by -> Random value between the first and second value
            adjustment_x = np.random.uniform(-2, 2)

            # TODO: CHANGE HOW MUCH TO ADJUST POINTS
            # How much to adjust y by -> Random value between the first and second value
...
if __name__ == '__main__':
    ...
    adjusted_df = adjust_points(df, 'Ninjago', 7.5, 100)
